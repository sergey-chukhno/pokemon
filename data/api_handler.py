...
class PokeAPIHandler:
    ...
    def fetch_pokemon_species(self, pokemon_id):
    ...
    def download_pokemon_sprite(self, pokemon_id):
    ...
    def initialize_pokemon_database(self, count=30):
        """Initialize the Pokemon database with the first 'count' Pokemon"""
        pokemon_list = []
        for i in range(1, count + 1):
            pokemon_data = self.fetch_pokemon_data(i)
            species_data = self.fetch_pokemon_species(i)
            if pokemon_data and species_data:
                ...
                pokemon = {
                    ...
                    'sprite_path': self.download_pokemon_sprite(i),
